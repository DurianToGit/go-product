...
type ProductEventConsumedModel struct {
	...
	Stream    string `gorm:"type:varchar(128);not null;uniqueIndex:uk_stream_msg,priority:1"`
	MsgID     string `gorm:"type:varchar(128);not null;uniqueIndex:uk_stream_msg,priority:2"`
