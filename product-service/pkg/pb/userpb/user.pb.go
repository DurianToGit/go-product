...
const file_proto_user_proto_rawDesc = "" +
	...
	"\x04list\x18\x01 \x03(\v2\x15.user.GetUserResponseR\x04list\x12\x14\n" +
	...
	"\n" +
	"UpdateUser\x12\x17.user.UpdateUserRequest\x1a\x18.user.UpdateUserResponse\"\x00\x12>\n" +
	"\tListUsers\x12\x16.user.ListUsersRequest\x1a\x17.user.ListUsersResponse\"\x00\x12M\n" +
	"\x0eUpdatePassword\x12\x1b.user.UpdatePasswordRequest\x1a\x1c.user.UpdatePasswordResponse\"\x00B\x1fZ\x1dproduct-service/pkg/pb/userpbb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	5,  // 0: user.ListUsersResponse.list:type_name -> user.GetUserResponse
	...
	10, // 6: user.UserService.UpdatePassword:input_type -> user.UpdatePasswordRequest
	...
	11, // 12: user.UserService.UpdatePassword:output_type -> user.UpdatePasswordResponse
